...
const COUCHDB_URL = "http://Nirmal:Nirmal@localhost:5984/users_db"; 
const COUCHDB_URL1 = "http://Nirmal:Nirmal@localhost:5984/fieldmobiliser_db";

//process.env.COUCHDB_PROD_URL;
if (!COUCHDB_URL || !COUCHDB_URL1) {
...
const db1 = new PouchDB(COUCHDB_URL1);
